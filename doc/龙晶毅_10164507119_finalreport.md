...
>我确实在编程中这方面做的比较差，但是也一直想要尝试一下，所以在最开始我想要先做一下登录和注册部分，甚至弄了一整天，都没有弄出来，整个项目都没有提示错误，但是又不能运行出来，我感觉到十分十分的挫败，一气之下把代码全删掉了，现在回想起来有点心疼。在后面进行编程的过程中，真的是痛并快乐着，实在想不出来要怎么打，但是当有所收获之后又感觉很开心。在这次项目中，收回最大的应该是终于对angular有了进一步的了解，也终于明白了路由的用法。路由真的是我一开始就特别特别好奇，也特别特别想要了解的内容。所以这是这个项目中最开心的事情。
